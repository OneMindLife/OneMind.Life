...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String tutorialRound2PromptTemplate(String winner) {
    return 'Le gagnant \'$winner\' est automatiquement reporte dans ce tour. Pouvez-vous proposer mieux pour le defier?';
  }
  ...
  @override
  String get tutorialProposingHintWithWinner => 'Le gagnant precedent a ete automatiquement reporte. Soumettez une idee pour le defier.';
  ...
  @override
  String get tutorialRatingBinaryHint => 'Quelle idee preferez-vous? Placez-la en haut (100). Placez celle que vous preferez le moins en bas (0). Utilisez [swap] pour les inverser, puis appuyez sur [check] pour confirmer.';

  @override
  String get tutorialRatingPositioningHint => 'Utilisez [up] et [down] pour deplacer l\'idee en surbrillance. Appuyez sur [check] pour la placer. Utilisez [undo] pour annuler un placement, et [zoomin] [zoomout] pour zoomer et dezoomer.';
  ...
  @override
  String get tutorialRound2Prompt => 'Le gagnant \'Succes\' est automatiquement reporte dans ce tour. Que pensez-vous que nous valorisons VRAIMENT?';
  ...
  @override
  String get tutorialSeeResultsHint => 'Appuyez sur le bouton ci-dessous pour voir comment toutes les idees ont ete classees.';

  @override
  String get tutorialSeeResultsContinueHint => 'Super! Maintenant vous comprenez comment le classement fonctionne. Au Round 2, vous soumettrez une nouvelle idee et tout le monde evaluera a nouveau.';
