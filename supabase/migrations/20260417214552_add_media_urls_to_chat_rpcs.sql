-- Expose initial_message_audio_url and initial_message_video_url on all chat RPCs
-- so Chat.fromJson receives them after refreshes (dashboard/translated fetches).
