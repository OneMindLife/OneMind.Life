...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get tutorialRound1Result =>
      '\'Succes\' a gagne ce tour! Pour devenir une reponse permanente, il doit gagner a nouveau au prochain tour.';
  ...
  String get tutorialProposingHintWithWinner =>
      'Pouvez-vous trouver mieux? Soumettez une idee pour defier le gagnant actuel.';

  @override
  String get tutorialRatingHint =>
      'Pour eviter les biais, chacun evalue toutes les idees sauf la sienne. La votre vous est cachee mais les autres l\'evalueront.';

  @override
  String get tutorialRatingBinaryHint =>
      'Quelle idee preferez-vous? Placez-la en haut (100). Utilisez [swap] pour les inverser, puis appuyez sur [check] pour confirmer.';

  @override
  String get tutorialRatingPositioningHint =>
      'Utilisez [up] et [down] pour deplacer l\'idee en surbrillance. Plus haut = plus d\'accord. Appuyez sur [check] pour la placer.';
  ...
  String get tutorialRound2Prompt =>
      'En voyant \'Succes\' comme la reponse actuelle du groupe - que pensez-vous que nous valorisons VRAIMENT?';
  ...
  String get tutorialSeeResultsHint =>
      'Appuyez ci-dessous pour voir comment toutes les idees ont ete classees.';

  @override
  String get tutorialSeeResultsContinueHint =>
      'Super! Maintenant vous comprenez comment le classement fonctionne. Continuez pour reessayer au Round 2.';
