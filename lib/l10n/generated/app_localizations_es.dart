...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get tutorialProposingHintWithWinner => 'Envia una nueva idea. Sera calificada junto con el ganador de la ronda anterior.';

  @override
  String get tutorialRatingHint => 'Ahora todos califican las ideas de los demas. Toca el boton para empezar a clasificar.';

  @override
  String get tutorialRatingBinaryHint => 'No veras tu propia idea aqui — otros la califican por ti. Cual de estas prefieres? Colocala en la parte superior (100). Coloca la que menos prefieras en la parte inferior (0). Usa [swap] para invertirlas, luego toca [check] para confirmar.';
