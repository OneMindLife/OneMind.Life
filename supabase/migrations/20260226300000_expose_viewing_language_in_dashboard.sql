-- =============================================================================
-- MIGRATION: Expose viewing_language_code in dashboard RPC
-- =============================================================================
-- Adds viewing_language_code to the return type of get_my_chats_dashboard
-- so the Flutter home screen can show which language each chat is set to.
-- =============================================================================

DROP FUNCTION IF EXISTS public.get_my_chats_dashboard(UUID, TEXT);

CREATE FUNCTION public.get_my_chats_dashboard(
    p_user_id UUID,
