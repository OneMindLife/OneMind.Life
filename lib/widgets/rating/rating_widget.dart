...
class RatingWidget extends StatefulWidget {
  ...
  @override
  State<RatingWidget> createState() => RatingWidgetState();
}

/// State class for RatingWidget, exposed for lazy loading operations
class RatingWidgetState extends State<RatingWidget>
  ...
  void _onModelChange() {
    ...
    if (_model.phase == RatingPhase.completed &&
        _model.isComplete &&
        !_hasAutoSubmitted) {
  ...
  List<Widget> _buildPropositionCards(double availableHeight) {
    ...
    final sortedPropositions =
        List<RatingProposition>.from(_model.rankedPropositions);
  ...
  Widget _buildControls() {
    ...
    return _model.phase == RatingPhase.binary
  ...
  void _startContinuousMove(double delta) {
    if (_model.phase != RatingPhase.positioning) return;
