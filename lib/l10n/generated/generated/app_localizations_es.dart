...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String tutorialRound1ResultTemplate(String winner) {
    return '\'$winner\' gano esta ronda! Sera llevado a la siguiente ronda, donde debe ganar de nuevo para convertirse en respuesta permanente.';
  }
  ...
  @override
  String get tutorialRound1Result => '\'Exito\' gano esta ronda! Sera llevado a la siguiente ronda, donde debe ganar de nuevo para convertirse en respuesta permanente.';
  ...
  String tutorialRatingTimeRemaining(String time) {
    return 'Te quedan $time para completar la fase de calificacion.';
  }
  ...
  String tutorialRound2Result(String proposition, String previousWinner) {
    return 'Tu idea \"$proposition\" gano! El ganador anterior, \"$previousWinner\", queda fuera de la competencia. Si tu idea gana la proxima ronda tambien, se convierte en respuesta permanente.';
  }
  ...
  String tutorialResultTapTabHint(String tabName) {
    return 'Ahora que conoces al ganador, veamos si puedes proponer algo mejor en la proxima ronda! Toca \"$tabName\" arriba para continuar.';
  }
  ...
  String tutorialRound2PromptSimplifiedTemplate(String winner) {
    return 'Es hora de la siguiente ronda! Puedes pensar en algo mejor que \'$winner\'?';
  }
  ...
  String tutorialResultsBackHint(String winner) {
    return '¡\'$winner\' ganó! Presiona la flecha de retroceso cuando termines de ver los resultados.';
  }
  ...
  @override
  String get multiLanguageDesc => 'Las proposiciones se traducen automaticamente entre idiomas';
  ...
  @override
  String get autoTranslateHint => 'Las proposiciones se traduciran automaticamente entre todos los idiomas seleccionados';
  ...
  @override
  String get homeTourWelcomeNameDesc => 'Este es tu nombre visible. Toca el icono del lapiz para cambiarlo en cualquier momento.';

  @override
  String get chatTourTitleTitle => 'Nombre del Chat';

  @override
  String get chatTourTitleDesc => 'Este es el nombre del chat. Cada chat tiene un tema que todos discuten juntos.';

  @override
  String get chatTourMessageTitle => 'Pregunta de Discusion';

  @override
  String get chatTourMessageDesc => 'Esta es la pregunta que se esta discutiendo. Todos envian ideas como respuesta.';

  @override
  String get chatTourProposingTitle => 'Enviar Ideas';

  @override
  String get chatTourProposingDesc => 'Aqui es donde escribes y envias tus ideas al comienzo de cada ronda.';

  @override
  String get chatTourParticipantsTitle => 'Participantes';

  @override
  String get chatTourParticipantsDesc => 'Conoce a los participantes del tutorial: Alice, Bob y Carol. Toca aqui para ver quien esta en el chat.';

  @override
  String get chatTourShareTitle => 'Compartir Chat';

  @override
  String get chatTourShareDesc => 'Comparte este chat con amigos usando un enlace de invitacion o codigo QR.';
}
