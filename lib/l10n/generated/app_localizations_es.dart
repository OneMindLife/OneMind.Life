...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get tutorialRound1Result =>
      '\'Exito\' gano esta ronda! Para ser una respuesta permanente, debe ganar de nuevo en la proxima ronda.';
  ...
  String get tutorialProposingHintWithWinner =>
      'Puedes pensar en algo mejor? Envia una idea para desafiar al ganador actual.';

  @override
  String get tutorialRatingHint =>
      'Para evitar sesgo, todos califican todas las ideas excepto la suya. La tuya esta oculta para ti pero otros la calificaran.';

  @override
  String get tutorialRatingBinaryHint =>
      'Cual idea prefieres? Colocala en la parte superior (100). Usa [swap] para invertirlas, luego toca [check] para confirmar.';

  @override
  String get tutorialRatingPositioningHint =>
      'Usa [up] y [down] para mover la idea resaltada. Mas arriba = mas de acuerdo. Toca [check] para colocarla.';
  ...
  String get tutorialRound2Prompt =>
      'Viendo \'Exito\' como la respuesta actual del grupo - que crees que REALMENTE valoramos?';
  ...
  String get tutorialSeeResultsHint =>
      'Toca abajo para ver como se clasificaron todas las ideas.';

  @override
  String get tutorialSeeResultsContinueHint =>
      'Genial! Ahora entiendes como funciona la clasificacion. Continua para intentarlo de nuevo en la Ronda 2.';

  @override
  String get tutorialResultsBackHint =>
      'Presiona la flecha de retroceso cuando termines de ver los resultados.';
