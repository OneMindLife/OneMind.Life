...
class GridRankingState extends Equatable {
...
/// Parameters for creating a GridRankingNotifier
...
class GridRankingNotifier extends AutoDisposeFamilyAsyncNotifier<GridRankingState, GridRankingParams> {
  ...
  @override
  Future<GridRankingState> build(GridRankingParams arg) async {
  ...
  Future<GridRankingState> _loadInitialPropositions() async {
  ...
  Future<GridRankingState> _resumeFromSavedRankings(
  ...
  Future<GridRankingState> _loadFreshPropositions() async {
