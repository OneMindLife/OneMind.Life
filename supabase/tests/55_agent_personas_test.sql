...
-- =============================================================================
-- TEST GROUP 2: Seed data — 5 personas exist with correct names
-- =============================================================================

SELECT is(
    (SELECT count(*)::int FROM agent_personas),
    5,
    '5 agent personas are seeded'
);
...
SELECT is(
    ...
    5,
    '5 agent pseudo-users exist in auth.users'
);
...
SELECT is(
    ...
    5,
    'All 5 personas link to valid auth.users entries'
);
...
SELECT has_function(
    ...
    ARRAY['integer'],
    'join_personas_to_chat(integer) function exists'
);
...
SELECT is(
    :joined_count,
    5,
    'join_personas_to_chat() joins 5 personas to the chat'
);
...
SELECT is(
    ...
    5,
    '5 participant rows created for agent personas'
);
...
SELECT ok(
    ...
    'Executor participant has correct display_name'
);
...
-- =============================================================================
-- TEST GROUP 8: Trigger fires correctly on phase transitions
-- =============================================================================
