-- =============================================================================
-- MIGRATION: Auto-pause should count human skips as participation
-- =============================================================================
-- Fix: A human explicitly skipping a round counts as active participation.
-- Only pause when users have completely abandoned the chat (no propositions
-- AND no skips from any human participant).
-- =============================================================================
...
BEGIN
    ...
    -- =========================================================================
    -- If agents are enabled and no human participated in this round (neither
    -- submitted a new proposition nor explicitly skipped), auto-pause the chat
    -- to stop agents from spinning indefinitely when users abandon a chat.
    -- Carried-forward propositions don't count — we only look at fresh activity.
    -- =========================================================================
...
'Handles round completion: tracks consensus, creates next round, carries forward winners with translations and category, and auto-pauses agent-only chats.';
