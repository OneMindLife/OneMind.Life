-- =============================================================================
-- MIGRATION: Auto-pause chat when round completes with only agent activity
-- =============================================================================
-- Safety mechanism: If a round finishes and no human submitted a new proposition
-- (only agents did), the chat auto-pauses via host_paused to prevent runaway
-- agent-only rounds from burning API credits indefinitely.
-- =============================================================================
...
'Handles round completion: tracks consensus, creates next round, carries forward winners, and auto-pauses agent-only chats.';
